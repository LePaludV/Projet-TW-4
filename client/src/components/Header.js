...
</svg> {txtLang[props.lang][5]}
  </button>
  <ul className="dropdown-menu" aria-labelledby="dropdownMenu2">
    <li><button className="dropdown-item" type="button" onClick={()=>props.setLang("en")}>{txtLang[props.lang][6]}</button></li>
    <li><button className="dropdown-item" type="button" onClick={()=>props.setLang("fr")}>{txtLang[props.lang][7]}</button></li>
    <li><button className="dropdown-item" type="button" onClick={()=>props.setLang("es")}>{txtLang[props.lang][8]}</button></li>
    <li><button className="dropdown-item" type="button" onClick={()=>props.setLang("de")}>{txtLang[props.lang][9]}</button></li>
  </ul>
</div>
          </div>
        </nav>
